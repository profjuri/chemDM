...
def save_params(input_dim, lr, hidden_dim, prop_hidden_dim, prop_pred_activation, prop_pred_dropout, prop_pred_depth, prop_growth_factor, epochs, counter, mse, mae, r2, model):
    ...
    with open(log_filepath, 'a') as file:
        if not file_exists:
            file.write("counter, lr, input_dim, hidden_dim, prop_hidden_dim, prop_pred_activation, prop_pred_dropout, prop_pred_depth, prop_growth_factor, epochs, mse, mae, r2\n")
        file.write(f'{counter},{input_dim},{lr},{hidden_dim},{prop_hidden_dim},{prop_pred_activation},{prop_pred_dropout},{prop_pred_depth},{prop_growth_factor},{epochs},{mse},{mae},{r2}\n')
...
####
    ...
    for i in range(num_of_cycles):
        ...
        batch_size = 128  # You can adjust this based on your hardware and dataset size
...
###
            ...
            if r2 > bestr2:
                ...
                save_params(input_dim, lr_random, hidden_dim, prop_hidden_dim, prop_pred_activation, prop_pred_dropout, prop_pred_depth, prop_growth_factor, epochs, counter, mse, mae, r2, model)
        counter = counter + 1
