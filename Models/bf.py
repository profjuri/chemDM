...
from functions_sub import selfies_to_all, lpoints_to_sequences, sequences_to_lpoints, try_encode, get_run_log_list, save_index, unique_values_and_first_indices, non_none_values_and_indices, generate_normal_tensor, sequences_to_smiles, sanitise_df
...
def final_sanitisation(settings):

    '''This is where the final sanitisation of the output csvs occurs. Molecules are validated, degeneracy is removed and SA scores are calculated.'''
    ...
    save_path = settings['data']['save_path']
    ID1_path = save_path + './ideal_mols.csv'
    ID2_path = save_path + './ideal_mols_2.csv'

    sanitise_df(ID1_path)
    sanitise_df(ID2_path)
